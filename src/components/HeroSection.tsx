          ...
          <div className="max-w-xl">
            ...
            <div className="flex items-center gap-4 mb-5">
              <Button size="lg" className="px-8 py-5 text-base bg-accent text-accent-foreground hover:bg-accent/85 shadow-lg hover:shadow-xl transition-all duration-300 font-bold tracking-wide rounded-full" asChild>
                <a href={appendUTM("https://pay.hotmart.com/B104628606K?off=ajvkspu0&checkoutMode=10&utm_source=site&utm_medium=cta&utm_campaign=imersao&utm_content=hero")} target="_blank" rel="noopener noreferrer">Garantir minha vaga</a>
              </Button>
        ...
        <div className="bg-brown-dark px-10 pt-8 pb-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-5">
            <Button size="lg" className="px-8 py-5 text-sm bg-accent text-accent-foreground hover:bg-accent/85 shadow-lg font-bold tracking-wide rounded-full" asChild>
              <a href={appendUTM("https://pay.hotmart.com/B104628606K?off=ajvkspu0&checkoutMode=10&utm_source=site&utm_medium=cta&utm_campaign=imersao&utm_content=hero_mobile")} target="_blank" rel="noopener noreferrer">Garantir minha vaga</a>
            </Button>
            <div className="text-white/60 font-sans text-sm">
              <span className="line-through mr-2">R$97,00</span>
              <span className="text-white font-bold text-lg">R$19,90</span>
